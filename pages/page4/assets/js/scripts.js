...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let cart = JSON.parse(localStorage.getItem('cart')) || []; // Load saved cart from localStorage
    let total = cart.reduce((sum, item) => sum + item.price, 0); // Calculate initial total from saved cart
